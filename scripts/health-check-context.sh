...
elif [ "$token_estimate" -gt 800000 ]; then
  echo "⚠️  Approaching token limit — consider further cleanup."  # Added a warning for approaching limit
else
