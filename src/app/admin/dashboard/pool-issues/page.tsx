...
export default function AdminPoolIssuesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold">Product Pool Issues</h1>
        <p className="text-muted-foreground">Review and manage reported issues between dispensaries in the product pool.</p>
      </div>
      <DataTable
        columns={columns}
        data={issues}
