...
import { Loader2, PackagePlus, ArrowLeft, Trash2, Leaf } from 'lucide-react';
                    ...
                    {Object.entries(categoryStructure).map(([categoryName, categoryData]) => (
                        ...
                        >
                            <div className="relative aspect-video w-full bg-muted overflow-hidden rounded-t-lg">
                                <Image src={categoryData.imageUrl} alt={categoryName} fill style={{objectFit: 'cover'}} className="transition-transform duration-300 group-hover:scale-105"/>
                            </div>
                    ...
                    <Card>
                        ...
                        <CardContent className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {Object.entries(showSubcategories).map(([subCategoryName, subCategoryData]) => (
                                ...
                                >
                                    <div className="relative aspect-video w-full bg-muted overflow-hidden rounded-t-lg">
                                        <Image src={subCategoryData.imageUrl} alt={subCategoryName} fill style={{objectFit: 'cover'}} className="transition-transform duration-300 group-hover:scale-105"/>
                                    </div>
                                    <CardContent className="p-4 flex-grow flex flex-col">
