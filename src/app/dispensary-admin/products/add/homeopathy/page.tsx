  ...
  return (
    <div class="max-w-5xl mx-auto my-8 space-y-6">
      <div class="flex items-center justify-between">
        <div>
          <h1 class="text-3xl font-bold">Add Homeopathy Product</h1>
          <p class="text-muted-foreground mt-1">Select a category to begin.</p>
        </div>
                ...
                <CardContent class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {categoryStructure.map(cat => (
                        ...
                        >
                            ...
                            <CardContent class="p-3 flex flex-col items-center flex-grow">
                                <p class="text-center font-semibold text-base">{cat.type}</p>
                                {form.watch('category') === cat.type && (
                                    <div class="w-full mt-4 animate-fade-in-scale-up">
            ...
            <div ref={finalFormRef}>
              {showFinalForm && (
                  <div class="space-y-6 animate-fade-in-scale-up" style={{animationDuration: '0.4s'}}>
                      <Separator />
                      <h3 class="text-2xl font-bold border-b pb-2">Step 2: Product Details</h3>
