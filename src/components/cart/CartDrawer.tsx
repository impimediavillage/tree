              ...
              <SheetFooter className="p-4 sm:p-6 border-t border-border mt-auto bg-muted/30">
                <div className="space-y-4 w-full">
                    ...
                    <div className="space-y-3">
                      <Button onClick={() => setIsCheckoutOpen(true)} className="w-full text-lg py-3 bg-primary hover:bg-primary/90 text-primary-foreground">
                          Proceed to Checkout
                      </Button>
                    ...
                    <p className="text-xs text-muted-foreground text-center pt-2">
                        <Info className="inline h-3 w-3 mr-1" /> Shipping will be calculated in the next step.
                    </p>
                </div>
              </SheetFooter>
            </>
