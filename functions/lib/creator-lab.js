...
exports.finalizeDesignComposite = (0, https_1.onCall)(async (request) => {
    ...
    try {
        ...
        const templateMetadata = await (0, sharp_1.default)(templateBuffer).metadata();
...
exports.generateModelShowcase = (0, https_1.onCall)({ secrets: [openaiApiKey] }, async (request) => {
    ...
    try {
        ...
        const modelImageResponse = await axios_1.default.get(imageUrl, { responseType: 'arraybuffer' });
        ...
        if (!logoImageUrl) {
            throw new https_1.HttpsError('failed-precondition', 'Design must have a logo');
        }
        const bucket = admin.storage().bucket();
        ...
        const modelMetadata = await (0, sharp_1.default)(modelImageBuffer).metadata();
        ...
        modelImageBuffer = await (0, sharp_1.default)(modelImageBuffer)
            .composite([{
                input: await (0, sharp_1.default)(logoBuffer)
