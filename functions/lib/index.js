...
var migrate_products_1 = require("./migrate-products");
Object.defineProperty(exports, "migrateProductCreatorFields", { enumerable: true, get: function () { return migrate_products_1.migrateProductCreatorFields; } });
...
var vendor_commissions_1 = require("./vendor-commissions");
Object.defineProperty(exports, "recordVendorSale", { enumerable: true, get: function () { return vendor_commissions_1.recordVendorSale; } });
Object.defineProperty(exports, "createVendorPayoutRequest", { enumerable: true, get: function () { return vendor_commissions_1.createVendorPayoutRequest; } });
Object.defineProperty(exports, "updateVendorEarningsOnPayoutChange", { enumerable: true, get: function () { return vendor_commissions_1.updateVendorEarningsOnPayoutChange; } });
...
var dispensary_type_management_1 = require("./dispensary-type-management");
Object.defineProperty(exports, "copyCategoryStructure", { enumerable: true, get: function () { return dispensary_type_management_1.copyCategoryStructure; } });
Object.defineProperty(exports, "createCategoryFromTemplate", { enumerable: true, get: function () { return dispensary_type_management_1.createCategoryFromTemplate; } });
Object.defineProperty(exports, "listCategoryDocuments", { enumerable: true, get: function () { return dispensary_type_management_1.listCategoryDocuments; } });
Object.defineProperty(exports, "deleteCategoryDocument", { enumerable: true, get: function () { return dispensary_type_management_1.deleteCategoryDocument; } });
Object.defineProperty(exports, "analyzeCategoryStructureAndUpdate", { enumerable: true, get: function () { return dispensary_type_management_1.analyzeCategoryStructureAndUpdate; } });
...
var driver_functions_1 = require("./driver-functions");
Object.defineProperty(exports, "onInHouseDeliveryCreated", { enumerable: true, get: function () { return driver_functions_1.onInHouseDeliveryCreated; } });
Object.defineProperty(exports, "onDeliveryStatusUpdate", { enumerable: true, get: function () { return driver_functions_1.onDeliveryStatusUpdate; } });
Object.defineProperty(exports, "onDriverStatsUpdate", { enumerable: true, get: function () { return driver_functions_1.onDriverStatsUpdate; } });
Object.defineProperty(exports, "onPayoutRequestUpdate", { enumerable: true, get: function () { return driver_functions_1.onPayoutRequestUpdate; } });
// Export Payout Notification functions
var payout_notifications_1 = require("./payout-notifications");
Object.defineProperty(exports, "onTreehousePayoutRequestCreated", { enumerable: true, get: function () { return payout_notifications_1.onTreehousePayoutRequestCreated; } });
Object.defineProperty(exports, "onTreehousePayoutRequestUpdated", { enumerable: true, get: function () { return payout_notifications_1.onTreehousePayoutRequestUpdated; } });
Object.defineProperty(exports, "onDispensaryPayoutRequestCreated", { enumerable: true, get: function () { return payout_notifications_1.onDispensaryPayoutRequestCreated; } });
Object.defineProperty(exports, "onDispensaryPayoutRequestUpdated", { enumerable: true, get: function () { return payout_notifications_1.onDispensaryPayoutRequestUpdated; } });
Object.defineProperty(exports, "onInfluencerPayoutRequestCreated", { enumerable: true, get: function () { return payout_notifications_1.onInfluencerPayoutRequestCreated; } });
Object.defineProperty(exports, "onInfluencerPayoutRequestUpdated", { enumerable: true, get: function () { return payout_notifications_1.onInfluencerPayoutRequestUpdated; } });
...
var social_media_posting_1 = require("./social-media-posting");
Object.defineProperty(exports, "connectSocialAccount", { enumerable: true, get: function () { return social_media_posting_1.connectSocialAccount; } });
Object.defineProperty(exports, "disconnectSocialAccount", { enumerable: true, get: function () { return social_media_posting_1.disconnectSocialAccount; } });
Object.defineProperty(exports, "refreshSocialToken", { enumerable: true, get: function () { return social_media_posting_1.refreshSocialToken; } });
Object.defineProperty(exports, "postToSocial", { enumerable: true, get: function () { return social_media_posting_1.postToSocial; } });
Object.defineProperty(exports, "getSocialAnalytics", { enumerable: true, get: function () { return social_media_posting_1.getSocialAnalytics; } });
// Export Stock Management functions
var stock_management_1 = require("./stock-management");
Object.defineProperty(exports, "deductStockOnOrderCreated", { enumerable: true, get: function () { return stock_management_1.deductStockOnOrderCreated; } });
Object.defineProperty(exports, "restoreStockOnOrderCancelled", { enumerable: true, get: function () { return stock_management_1.restoreStockOnOrderCancelled; } });
Object.defineProperty(exports, "lowStockAlert", { enumerable: true, get: function () { return stock_management_1.lowStockAlert; } });
...
exports.createDispensaryUser = (0, https_1.onCall)({ secrets: [smtpUser, smtpPass] }, async (request) => {
    if (request.auth?.token.role !== 'Super Admin') {
    ...
    try {
        ...
        if (cart && cart.length > 0) {
            ...
            cart.forEach(item => {
                ...
                if (item.length && item.length > maxLength)
                    maxLength = item.length;
                if (item.width && item.width > maxWidth)
                    maxWidth = item.width;
                if (item.height && item.height > maxHeight)
...
exports.submitDispensaryApplication = (0, https_1.onCall)({ cors: true, secrets: [smtpUser, smtpPass] }, async (request) => {
 ...
 */
exports.onDispensaryStatusChange = (0, firestore_1.onDocumentWritten)({
 ...
 */
exports.sendCrewMemberEmail = (0, https_1.onCall)({ secrets: [smtpUser, smtpPass] }, async (request) => {
    ...
    if (!dispensaryName || !memberName || !memberEmail || !memberRole || !temporaryPassword) {
        throw new https_1.HttpsError('invalid-argument', 'Missing required email data');
    }
    try {
        ...
        await (0, email_service_1.sendCrewMemberWelcomeEmail)({
            dispensaryName,
            memberName,
            memberEmail,
            memberRole,
